...
class FinishStudy extends Component {
    ...
    render() { 
        ...
        if(this.state.result){
           ...
           var total_studied_study_hour = total_result.study_hour
           ...
           var read_studied_study_hour = read_result.study_hour
           ...
           var flip_studied_study_hour = flip_result.study_hour
        ...
        if(this.state.by_book){
            var byBook = this.state.by_book.map(item=>{
                ...
                const total_study_hour = item.total.study_hour
                ...
                return <>
                    <div key={book_id} style={{fontSize:"11px", marginBottom:"20px", display:"flex", justifyContent:"space-between"}}>
                        <ul>
                            ...
                            <li style={{marginTop:"5px"}}>학습시간 총합 : {total_study_hour}</li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li style={{marginTop:"5px"}}>학습시간 : {total_studied_study_hour}</li>
                        ...
                        <ul>
                            ...
                            <li style={{marginTop:"5px"}}>학습시간 : {read_studied_study_hour}</li>
                        ...
                        <ul>
                            ...
                            <li style={{marginTop:"5px"}}>학습시간 : {flip_studied_study_hour}</li>
