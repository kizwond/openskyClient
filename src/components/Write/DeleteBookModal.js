...
class DeleteBook extends Component {
  ...
  showPromiseConfirm = (book, event) => {
    confirm({
      title: [`[${this.state.bookTitle.title}] 책을 삭제하시겠습니까?`],
      ...
      onOk() {  
        event({book_id:book.book_id, seq_in_category:book.seq_in_category, seq_in_like:book.seq_in_like, category_id:book.category_objectID.category_id})
      },
      onCancel() {},
    });
  }
